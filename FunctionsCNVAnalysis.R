...
# add.color.to.snp.info add colour scheme for plotting cnv/snp data mono = all col1, alternate = alternate between col1 and col2, unique = all different, hilite all col2 except 'hilite' chr2(s)
# add.gindx.to.Ranges
