...
fam.file <- "/chiswick/data/ncooper/metabochipRunTest/ANNOTATION/snpdataCustom.fam"
...
base.settings <- list(dt.name="datatracker",
                      ...
                      manual.col.nums=NULL,plink.imp=T,fet.analysis.p=0.05,HD.mode=F,
                      n.cores=22,low.ram=F,ped.file=fam.file,
